...
<head>
    ...
    <title>Lupa Password - CitizenLink</title>
...
<body class="font-sans antialiased"
    ...
    <div class="min-h-screen flex flex-col justify-center items-center relative transition-colors duration-300 p-6">
        ...
        <div class="mb-8 text-center">
            ...
            <h2 class="text-3xl font-black tracking-tighter uppercase mb-2">Lupa Password?</h2>
        </div>
        ...
        <div class="w-full max-w-md p-8 rounded-[40px] border shadow-2xl transition-all duration-300 relative overflow-hidden"
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                @csrf
                <div class="group">
                    <label class="text-[10px] font-black uppercase tracking-widest opacity-60 mb-2 block">Email Terdaftar</label>
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full py-4 rounded-2xl font-black uppercase text-xs tracking-[0.1em] transition-all transform hover:scale-[1.02] hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-3 relative overflow-hidden group"
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-[10px] font-black uppercase tracking-widest opacity-50 hover:opacity-100 hover:text-cyan-500 transition-all">
