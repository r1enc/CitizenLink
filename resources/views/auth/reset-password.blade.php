...
<head>
    ...
    <title>Reset Password - CitizenLink</title>
...
<body class="font-sans antialiased"
    ...
    <div class="min-h-screen flex flex-col justify-center items-center relative transition-colors duration-300 p-6">
        ...
        <div class="mb-8 text-center">
            ...
            <h2 class="text-3xl font-black tracking-tighter uppercase mb-2">Password Baru</h2>
        </div>
        ...
        <div class="w-full max-w-md p-8 rounded-[40px] border shadow-2xl transition-all duration-300 relative overflow-hidden"
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                <div class="group">
                    <label class="text-[10px] font-black uppercase tracking-widest opacity-60 mb-1 block">Email</label>
                ...
                <div class="group">
                    <label class="text-[10px] font-black uppercase tracking-widest opacity-60 mb-1 block">Password Baru</label>
                ...
                <div class="group">
                    <label class="text-[10px] font-black uppercase tracking-widest opacity-60 mb-1 block">Konfirmasi Password</label>
